...
export default function EnquiryForm({
  ...
  const isNoidaContext = location.pathname.includes('noida') || location.pathname.startsWith('/services');
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[#4B5563] dark:text-gray-400 text-sm font-medium mt-1">
                    {isNoidaContext ? "+91 7987059430" : "+91 9217179762"}
                  </div>
                </div>
              </a>
